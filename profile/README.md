...
#### [markflow](https://github.com/claude-code-expert/markflow) — 마크다운 기반 팀 지식 관리 플랫폼 (KMS)

팀 단위로 사용하는 마크다운 기반 Knowledge Management System입니다. 독립형 에디터 패키지, Next.js 16 프론트엔드, Fastify 5 백엔드, Drizzle ORM 스키마가 분리된 모노레포 구조로 설계되어 npm 배포와 셀프호스팅을 동시에 지원합니다.

- **기술 스택**: Next.js 16 · Fastify 5 · CodeMirror 6 · remark/rehype · KaTeX · Drizzle ORM · PostgreSQL 16 · Zustand · React Query · Tailwind CSS 4
- **주요 기능**: 독립 배포 가능한 마크다운 에디터(`@markflow/editor`), 워크스페이스 기반 RBAC(소유자/관리자/편집자/뷰어), 문서 CRUD · 버전 관리, 카테고리 closure 계층 구조, 문서 간 연관 관계, 태그 · 댓글 · 초대 · 임베드 토큰, 수식 · 코드 하이라이팅, rehype-sanitize XSS 방어
- **배포 아키텍처**: Vercel(web) + Railway/Render/Fly.io(api) + Supabase/Neon(DB) + Cloudflare R2 Worker(이미지 업로드)

<img src="https://raw.githubusercontent.com/claude-code-expert/.github/main/profile/assets/mark-1.png" alt="MarkFlow 랜딩" width="100%" />
<p align="center"><em>MarkFlow Landing</em></p>

<img src="https://raw.githubusercontent.com/claude-code-expert/.github/main/profile/assets/mark-2.png" alt="MarkFlow 특징" width="100%" />
<p align="center"><em>MarkFlow Features</em></p>

<img src="https://raw.githubusercontent.com/claude-code-expert/.github/main/profile/assets/mark-3.png" alt="MarkFlow 문서 작성" width="100%" />
<p align="center"><em>MarkFlow Document Authoring</em></p>

<img src="https://raw.githubusercontent.com/claude-code-expert/.github/main/profile/assets/mark-4.png" alt="MarkFlow 연관 문서 구조" width="100%" />
